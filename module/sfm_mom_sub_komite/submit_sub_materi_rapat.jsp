...
try {
	...
	String isi_rapat_sub_materi	= request.getParameter("isi_rapat_sub_materi");
	String batas_waktu_sub_materi		= request.getParameter("batas_waktu_sub_materi");
	String status_sub_materi	= request.getParameter("status_sub_materi");
	String keterangan_sub_materi	= request.getParameter("keterangan_sub_materi");
	...
	String p = "";
	String s = "";
	if (id_rapat_sub_materi.equals("")){
		id_rapat_sub_materi = Long.toString(date.getTime());
	}
	...
	if (dml.equals("insert")) {
		...
		p	= "insert into t_pic_rapat_sub_materi ("
			...
			+ nipg_pelaksana +"', '"
			+ id_user +"' )";
		s	= "insert into t_pic_rapat_sub_materi_detail ("
			+" 		id_rapat "
			+" , 	id_rapat_materi "
			+" , 	id_rapat_sub_materi "
			+" ,	nipg "
		...
		q	=" delete from	t_rapat_sub_materi "
			+" where	id_rapat   =  "+ id_rapat +" and id_rapat_materi = "+ id_rapat_materi +" and id_rapat_sub_materi = "+ id_rapat_sub_materi;
	} else {
