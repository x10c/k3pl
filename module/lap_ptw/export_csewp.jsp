...
<head>
<title>CONFINED SPACE ENTRY PERMIT</title>
<style type="text/css">
<![CDATA[
html {
	padding		: 10px;
...
<div class="div-center"><span class="csewp_no">NO. <%= rs.getString("csewp_no") %></span></div>
<div class="content">
