...
String		no_lisensi			= "";
String		sumber_radioaktif	= "";
String		proyektor			= "";
String		survey_meter		= "";
String		tgl_service			= "";
String		tgl_kalibrasi		= "";
...
<head>
<title>RADIOGRAPHIC WORK PERMIT</title>
<style type="text/css">
<![CDATA[
html {
	padding		: 10px;
...
SBU DISTRIBUSI WILAYAH I - JAWA BAGIAN BARAT <br/>
	</th>
...
<%
	q	=" select	nomor															as rwp_no"
		...
		+" ,		proyektor"
		+" ,		survey_meter"
		+" ,		replace(convert(varchar, tanggal_service, 111), '/', '-')		as tgl_service"
		+" ,		replace(convert(varchar, tanggal_kalibrasi, 111), '/', '-')		as tgl_kalibrasi"
		+" from		t_ptw"
		+" where	jenis_ptw	= 4"
		+" and		id_ptw		= "+ id_ptw;
	...
	nm_perusahaan		= rs.getString("nama_perusahaan");
	...
	tgl_service			= rs.getString("tgl_service");
	tgl_kalibrasi		= rs.getString("tgl_kalibrasi");

%>

<div class="div-center"><span class="rwp_no">NO. <%= rs.getString("rwp_no") %></span></div>
<div class="content">
...
<div class="content-box">
<b> C. DESKRIPSI PEKERJA RADIOGRAFI </b>
<table class="content-table">
	<tr><td class="thdr">Nama Perusahaan</td><td class="tsep">:</td>
		<td class="tval" colspan="5">
			<%= nm_perusahaan %>
		</td>
	</tr>
	<tr><td class="thdr">No.Lisensi</td><td class="tsep">:</td>
		<td class="tval" colspan="5">
			<%= no_lisensi %>
		</td>
	</tr>
	<tr><td class="thdr">Sumber Radioaktif</td><td class="tsep">:</td>
		<td class="tval" colspan="5">
			<%= sumber_radioaktif %>
		</td>
	</tr>
	<tr><td class="thdr">Proyektor</td><td class="tsep">:</td>
		<td class="tval" colspan="5">
			<%= proyektor %>
		</td>
	</tr>
	<tr><td class="thdr">Survey Meter</td><td class="tsep">:</td>
		<td class="tval" colspan="5">
			<%= survey_meter %>
		</td>
	</tr>
	<tr><td class="thdr">Tanggal Service</td><td class="tsep">:</td>
		<td class="tval" colspan="5">
			<%= tgl_service %>
		</td>
	</tr>
	<tr><td class="thdr">Tanggal Kalibrasi</td><td class="tsep">:</td>
		<td class="tval" colspan="5">
			<%= tgl_kalibrasi %>
		</td>
	</tr>
