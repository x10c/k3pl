...
function M_TrxJSAMaster(title)
{
	...
	this.do_print = function(){
		...
		form.setAttribute('action', _g_root +'/module/lap_jsa/data_jsa_export.jsp');
		
		var hiddenField1 = document.createElement ('input');
        hiddenField1.setAttribute('type', 'hidden');
        hiddenField1.setAttribute('name', 'id_jsa');
        hiddenField1.setAttribute('value', m_trx_jsa_id_jsa);
