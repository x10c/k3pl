...
var m_app_reset_jam_kerja;
var m_app_reset_jk_d = _g_root +'/module/app_reset_jam_kerja/';
...
function M_AppResetJamKerja()
{
	...
	,	dataIndex	: 'nama_klas'
		...
		header		: 'Jumlah Korban Mati'
	,	dataIndex	: 'jml_korban_mati'
	},{
		header		: 'Status Reset'
	,	dataIndex	: 'status_reset'
	...
	this.panel = new Ext.grid.GridPanel({
		title		: 'Reset Jam Kerja'
	,	id		: 'app_reset_jam_kerja_panel'
	,	store		: this.store
	,	cm		: this.cm
	,	plugins		: this.editor
	...
	this.do_save = function(record)
	{
		...
		Ext.Ajax.request({
			url	: m_app_reset_jk_d +'submit.jsp'
		,	params	: {
...
m_app_reset_jam_kerja = new M_AppResetJamKerja();

//@ sourceURL=app_reset_jam_kerja.layout.js
