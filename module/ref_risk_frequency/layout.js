 ...
 */
var m_ref_risk_frequency;
var m_ref_risk_frequency_d = _g_root +'/module/ref_risk_frequency/';

function M_RefRiskFrequency(title)
{
	this.dml_type	= 0;
	this.ha_level	= 0;

	this.record = new Ext.data.Record.create([
			{ name	: 'id_risk_frequency' }
		,	{ name	: 'description' }
		,	{ name	: 'frequency' }
	...
	this.store = new Ext.data.ArrayStore({
			fields	: this.record
		,	url		: m_ref_risk_frequency_d +'data.jsp'
		,	autoLoad: false
		});
...
m_ref_risk_frequency = new M_RefRiskFrequency('Risk Frequency');

//@ sourceURL=ref_risk_frequency.layout.js
