...
try {
	...
	String		metode_pengelolaan		= request.getParameter("metode_pengelolaan");
	String		periode_pengelolaan		= request.getParameter("periode_pengelolaan");
	String		hasil_pengelolaan		= request.getParameter("hasil_pengelolaan");
	...
	case 2:
		q	=" insert into t_lingkungan_detail (id_lingkungan_tahunan, id_komponen_lingkungan, lokasi_dampak, jenis_dampak,"
			+" sumber_dampak, metode_pengelolaan, periode_pengelolaan, hasil_pengelolaan,"
	...
	case 3:
		q	=" update t_lingkungan_detail "
			...
			+" , metode_pengelolaan		= '"+ metode_pengelolaan +"' "
			+" , periode_pengelolaan	= '"+ periode_pengelolaan +"' "
			+" , hasil_pengelolaan		= '"+ hasil_pengelolaan +"' "
