...
try {
	...
	String isi_rapat_materi;
	String batas_waktu_materi;
	String status_materi;
	String keterangan_materi;
	...
	for (i = 0; i < l; i++) {
		...
		isi_rapat_materi 	= data_obj.getString("isi_rapat_materi");
		batas_waktu_materi	= data_obj.getString("batas_waktu_materi");
		status_materi		= data_obj.getString("status_materi");
		keterangan_materi	= data_obj.getString("keterangan_materi");
		...
		if (batas_waktu_materi.equals("") || batas_waktu_materi.equals("undefined") || batas_waktu_materi.equals("-")){
				batas_waktu_materi = null;
		}
		else{
			batas_waktu_materi = "\'"+ batas_waktu_materi +"\'";
		}
		if (keterangan_materi.equals("") || keterangan_materi.equals("undefined")){
			keterangan_materi = null;
		}
		else{
		...
		if (dml.equals("insert")) {
			...
			if (seksi_pelaksana.equals("") || seksi_pelaksana.equals("undefined") || seksi_pelaksana.equals("-")){
				...
				p 	=" if exists("
					+"	select	*"
					+"	from	t_pic_rapat_materi"
					+"	where	id_rapat	= "+ id_rapat
					+"	and	id_rapat_materi		= "+ id_rapat_materi
					+" ) begin"
					+"	update	t_pic_rapat_materi"
					+"	set	nipg_pelaksana	= '"+ nipg_pelaksana +"' "
					...
					+"	and	id_rapat_materi		= "+ id_rapat_materi
					+" end else begin "
					+" insert into t_pic_rapat_materi ("
					+" 		id_rapat "
					+" , 	id_rapat_materi "
					+" ,	nipg_pelaksana "
					+" ,	seksi_pelaksana "
