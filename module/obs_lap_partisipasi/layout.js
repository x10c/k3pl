...
function M_ObsLapPartPegGrid()
{
	...
	this.do_print = function()
	{
		...
		url += '?id=27';
		url	+= '&type=xls';
		url += '&is_in_org='+ (m_obs_lap_partisipasi.part_peg.form.set_org.isChecked() ? 1 : 0);
		url += '&id_dir='+ m_obs_lap_partisipasi.part_peg.form.set_org.formDirektorat.getValue ();
		url += '&id_div='+ m_obs_lap_partisipasi.part_peg.form.set_org.formDivProSBU.getValue ();
		url += '&id_dep='+ m_obs_lap_partisipasi.part_peg.form.set_org.formDepartemen.getValue ();
		url += '&id_dinas='+ m_obs_lap_partisipasi.part_peg.form.set_org.formDinas.getValue ();
		url += '&id_seksi='+ m_obs_lap_partisipasi.part_peg.form.set_org.formSeksi.getValue ();
		url += '&id_wilayah='+ m_obs_lap_partisipasi.part_peg.form.set_wil.formWilayah.getValue ();
		url += '&id_area='+ m_obs_lap_partisipasi.part_peg.form.set_wil.formArea.getValue ();
		url += '&year='+ m_obs_lap_partisipasi.part_peg.form.set_waktu.formTahun.getValue ();
...
function M_ObsLapPartOrgGrid()
{
	...
	this.do_print = function()
	{
		...
		url += '?id=28';
		url	+= '&type=xls';
		url += '&is_in_org='	+ (m_obs_lap_partisipasi.part_org.form.set_org.isChecked() ? 1 : 0);
		url += '&id_dir='		+ m_obs_lap_partisipasi.part_org.form.set_org.formDirektorat.getValue ();
		url += '&id_div='		+ m_obs_lap_partisipasi.part_org.form.set_org.formDivProSBU.getValue ();
		url += '&id_dep='		+ m_obs_lap_partisipasi.part_org.form.set_org.formDepartemen.getValue ();
		url += '&id_dinas='		+ m_obs_lap_partisipasi.part_org.form.set_org.formDinas.getValue ();
		url += '&id_seksi='		+ m_obs_lap_partisipasi.part_org.form.set_org.formSeksi.getValue ();
		url += '&id_wilayah='	+ m_obs_lap_partisipasi.part_org.form.set_wil.formWilayah.getValue ();
		url += '&id_area='		+ m_obs_lap_partisipasi.part_org.form.set_wil.formArea.getValue ();
		url += '&year='			+ m_obs_lap_partisipasi.part_org.form.set_waktu.formTahun.getValue ();
		url += '&month='		+ m_obs_lap_partisipasi.part_org.form.set_waktu.formBulan.getValue ();
