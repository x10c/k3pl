...
try{
	...
	String nama_item_ca			= request.getParameter("nama_item_ca");
	String q;

	switch (dml) {
	case 2:
		q	=" insert into r_item_ca ("
			+"	nama_item_ca "
			+" ,	id_kategori_item_ca "
			+" ,	id_user "
			+" ) values ("
	...
	case 3:
		q	=" update	r_item_ca "
			+" set		nama_item_ca	= '"+ nama_item_ca +"' "
			+" ,		id_user			= '"+ id_user +"' "
			+" where	id_item_ca		= "+ id_item_ca;
		break;
	case 4:
		q	=" delete from	r_item_ca "
			+" where	id_item_ca = "+ id_item_ca
