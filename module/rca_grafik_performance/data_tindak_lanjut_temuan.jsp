...
+" from"
+" ("
+" 	select	convert(decimal(18,2), case when count(b.id_rca) = 0 then 0 else (1.0 * (count(b.id_rca) * 100) / [k3pl].[dbo].[FN_GET_TEMUAN_45_DEP](" + year + "," + month + ",1)) end) as jumlah "
+"	from	t_rca			as a "
+"	,		t_rca_detail	as b "
+"	where	a.id_rca						= b.id_rca "
+"	and		month(a.tanggal_rca)			= " + month
+"	and		year(a.tanggal_rca)				= " + year
+"	and		b.id_severity					in (4,5) "
+"	and		b.status						in ('2','3') "
+"	and		a.penanggung_jawab_departemen	= 1 "
+" ) PL,"
+" ("
+" 	select	convert(decimal(18,2), case when count(b.id_rca) = 0 then 0 else (1.0 * (count(b.id_rca) * 100) / [k3pl].[dbo].[FN_GET_TEMUAN_45_DEP](" + year + "," + month + ",2)) end) as jumlah "
+"	from	t_rca			as a "
+"	,		t_rca_detail	as b "
+"	where	a.id_rca						= b.id_rca "
+"	and		month(a.tanggal_rca)			= " + month
...
+" ) OP,"
+" ("
+" 	select	convert(decimal(18,2), case when count(b.id_rca) = 0 then 0 else (1.0 * (count(b.id_rca) * 100) / [k3pl].[dbo].[FN_GET_TEMUAN_45_DEP](" + year + "," + month + ",3)) end) as jumlah "
+"	from	t_rca			as a "
+"	,		t_rca_detail	as b "
+"	where	a.id_rca						= b.id_rca "
+"	and		month(a.tanggal_rca)			= " + month
...
+" ) IJK,"
+" ("
+" 	select	convert(decimal(18,2), case when count(b.id_rca) = 0 then 0 else (1.0 * (count(b.id_rca) * 100) / [k3pl].[dbo].[FN_GET_TEMUAN_45_DEP](" + year + "," + month + ",4)) end) as jumlah "
+"	from	t_rca			as a "
+"	,		t_rca_detail	as b "
+"	where	a.id_rca						= b.id_rca "
+"	and		month(a.tanggal_rca)			= " + month
...
+" ) EP,"
+" ("
+" 	select	convert(decimal(18,2), case when count(b.id_rca) = 0 then 0 else (1.0 * (count(b.id_rca) * 100) / [k3pl].[dbo].[FN_GET_TEMUAN_45_DEP](" + year + "," + month + ",5)) end) as jumlah "
+"	from	t_rca			as a "
+"	,		t_rca_detail	as b "
+"	where	a.id_rca						= b.id_rca "
+"	and		month(a.tanggal_rca)			= " + month
...
+" ) KS,"
+" ("
+" 	select	convert(decimal(18,2), case when count(b.id_rca) = 0 then 0 else (1.0 * (count(b.id_rca) * 100) / [k3pl].[dbo].[FN_GET_TEMUAN_45_DEP](" + year + "," + month + ",6)) end) as jumlah "
+"	from	t_rca			as a "
+"	,		t_rca_detail	as b "
+"	where	a.id_rca						= b.id_rca "
+"	and		month(a.tanggal_rca)			= " + month
...
+" ) LAU,"
+" ("
+" 	select	convert(decimal(18,2), case when count(b.id_rca) = 0 then 0 else (1.0 * (count(b.id_rca) * 100) / [k3pl].[dbo].[FN_GET_TEMUAN_45_ALL](" + year + "," + month + ")) end) as jumlah "
+"	from	t_rca			as a "
+"	,		t_rca_detail	as b "
+"	where	a.id_rca						= b.id_rca "
+"	and		month(a.tanggal_rca)			= " + month
